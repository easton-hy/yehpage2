...
function erling_tm_modalbox_news(){
	...
	var button			= jQuery('.erling_tm_research .pro-item h1 a');
	var closePopup		= modalBox.find('.close');
	
	button.on('click',function(){
		var element 	= jQuery(this);
		var parent 		= element.closest('.pro-item');
		...
		//modalBox.find('.news_popup_informations').prepend('<div class="image"><img src="img/research/210911@DG.jpg" alt="" /></div>');
