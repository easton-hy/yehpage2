...
\item {{\bf Teaching Assistant}\\ 2025-2026, Rutgers University, Advisor: Prof. Jingang Yi}\\
...
\begin{rSubsection}{}{}
{}{}
    \item { {\bf Y. Huang}, F. Han, J. Yi. 'Data-Efficient Learning-Based Estimation of Region of Attractions for Nonlinear Dynamic Systems,' 2025 IEEE 21st International Conference on Automation Science and Engineering (CASE). (Accepted) }\\
	\item { {\bf Y. Huang}, F. Han, T. Zheng, L. Hu, J. Yi, Y. Guo. 'Physics-Informed Machine Learning-Based Chattering Prediction in Milling Process,' 2025 American Control Conference. (Accepted) }\\
